    ...
    static projectCardTemplate(project) {
        ...
        <div class="col-4">
            <div class="card" data-id="${project.id}">
                ${project.img ? `<img class="card-img-top" src="${project.img}" alt="Project image">` : ''}
                <div class="card-body">
                    <h5 class="card-title">${project.name}</h5>
                    <p class="card-text">${project.description}</p>
                    <a href="#" class="btn btn-primary edit-btn" data-toggle="modal" data-target="#editProject">Edit</a>
